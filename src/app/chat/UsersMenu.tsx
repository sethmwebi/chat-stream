...
export default function UsersMenu({
  ...
  const [searchInput, setSearchUserInput] = useState("");
    ...
    <div className="str-chat absolute z-10 h-full w-full overflow-y-auto border-e border-e-[#dbdde1] bg-white dark:border-e-gray-800 dark:bg-[#17191c]">
      <div className="flex flex-col p-3">
        ...
        <input
          type="search"
          placeholder="Search"
          className="rounded-full border-2 border-gray-300 bg-transparent px-4 py-2 outline-none dark:border-gray-800 dark:text-white"
          value={searchInput}
